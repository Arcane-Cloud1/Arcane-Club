...
export function ProfileSettingsDialog({ 
  ...
  useEffect(() => {
    if (initialData && open) {
      ...
      if (initialData.avatar) setAvatarPreview(`http://localhost:5000${initialData.avatar}`);
      if (initialData.backgroundImage) setBackgroundPreview(`http://localhost:5000${initialData.backgroundImage}`);
      // Reset files
      setAvatar(null);
      setBackground(null);
    }

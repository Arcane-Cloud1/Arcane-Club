...
async function getPage(slug: string) {
  try {
    ...
    // For simplicity in this environment, I'll assume axios works if baseUrl is set to localhost:5000/api
    ...
    const res = await fetch(`http://localhost:5000/api/misc/pages/${slug}`, {
      cache: 'no-store' 
    });
